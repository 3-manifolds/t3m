...
#else
#define FILE5   "Tables/CuspedCensusData/terse5.bin"
#define FILE6o  "Tables/CuspedCensusData/terse6o.bin"
#define FILE6n  "Tables/CuspedCensusData/terse6n.bin"
#define FILE7o  "Tables/CuspedCensusData/terse7o.bin"
#define FILE7n  "Tables/CuspedCensusData/terse7n.bin"
#endif
...
static TersestTriangulation *ReadCensusBuffer(char *aFileName, int aNumManifolds);
    ...
    int             anIndex)
{
    ...
    switch (aNumTetrahedra)
    {
        case 5:
            ...
            if (theData5 == NULL)
                theData5 = ReadCensusBuffer(FILE5, theNumCensusManifolds);
            theData = theData5;
        ...
        case 6:
            ...
            switch (anOrientability)
            {
                case oriented_manifold:
                    if (theData6o == NULL)
                        theData6o = ReadCensusBuffer(FILE6o, theNumCensusManifolds);
                    theData = theData6o;
                ...
                case nonorientable_manifold:
                    if (theData6n == NULL)
                        theData6n = ReadCensusBuffer(FILE6n, theNumCensusManifolds);
                    theData = theData6n;
        ...
        case 7:
            ...
            switch (anOrientability)
            {
                case oriented_manifold:
                    if (theData7o == NULL)
                        theData7o = ReadCensusBuffer(FILE7o, theNumCensusManifolds);
                    theData = theData7o;
                ...
                case nonorientable_manifold:
                    if (theData7n == NULL)
                        theData7n = ReadCensusBuffer(FILE7n, theNumCensusManifolds);
                    theData = theData7n;
